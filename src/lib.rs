...
//!   let image: oci_distribution::Reference = "registry-testing.svc.lan/kubewarden/disallow-service-nodeport:v0.1.0".parse().unwrap();
...
//!   let cosign_image: oci_distribution::Reference = "registry-testing.svc.lan/kubewarden/disallow-service-nodeport:sha256-5f481572d088dc4023afb35fced9530ced3d9b03bf7299c6f492163cb9f0452e.sig".parse().unwrap();
//!   // Obtained via `triangulate`
